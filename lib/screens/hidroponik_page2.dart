...
class HidroponikPage2 extends StatefulWidget {
  @override
  _HidroponikPage2State createState() => _HidroponikPage2State();
}

class _HidroponikPage2State extends State<HidroponikPage2> {
  ...
  void _processChartData(Map<String, dynamic> jsonResponse) {
    ...
    jsonResponse['sensors'].forEach((key, value) {
      try {
        ...
        double suhuValue = value['ESP2']['temperature-2']?.toDouble() ?? 0.0;
        double kekeruhanValue = value['ESP2']['turbidity-2']?.toDouble() ?? 0.0;
  ...
  child: Row(
    children: [
      ...
      Text(
        "Status Hidroponik 2", // Teks yang ditambahkan
        style: TextStyle(
          fontSize: 20,
          fontWeight: FontWeight.bold,
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    CardData(
                      title: "Suhu",
                      value: "${latestData['ESP2']['temperature-2']} °C",
                      icon: Icons.thermostat,
                    ),
                    CardData(
                      title: "Kekeruhan",
                      value: "${latestData['ESP2']['turbidity-2']} NTU",
                      icon: Icons.opacity,
                    ),
                  ],
                ),
